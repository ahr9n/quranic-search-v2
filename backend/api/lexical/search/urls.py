...
urlpatterns = [
    ...
    path('api/lexical/verse-in-surah/<int:surah_id>/<int:verse_id>', get_verse_in_surah, name='get_verse_in_surah'),
    path('api/lexical/verse-in-quran/<int:verse_id>', get_verse_in_quran, name='get_verse_in_quran'),
]
